...
<html lang="en">
    ...
    <body>
        <div class="wrapper">
            ...
            <p>Join tTrend to get tech insights</p>
            <p id="error-message"></p>
            <form id="form" action="/myapp/test/public/register" method="POST"> 
                <div>
            ...
            <p>Already have an account? <a href="/myapp/test/public/login">Login</a></p>
        </div>
    </body>
</html>